      ...
      <div id="profile-container">
        ...
        <div class="forms-container">
          <div class="form-container">
            ...
            <button class="fill" @click="updatePersonalInfo">Save the information</button>
          </div>
          <div class="form-container">
            <div class="settings-header-mid">Password</div>
            <form class="password-container">
              <div class="password-input">
                <input type="password" class="password" v-model="oldPassword" ref="input" placeholder="Old password"
                       required>
                <img src="../../../assets/icons/eye.svg" @click="changeVisibility('input')">
              </div>
              <div class="password-input">
                <input type="password" class="password" v-model="newPassword" ref="inputConfirm"
            ...
            <button class="fill" @click="updatePassword">Change your password</button>
          </div>
          <div class="form-container">
...
export default {
  ...
  methods: {
    ...
    async deactivateUser() {
      await axios.post(`${url}/users/deactivate`, {
        email: this.email
      }).then(res => {
        alert(res.data)
    ...
    async deleteUser() {
      await axios.delete(`${url}/users/${this.email}`).then(res => {
        alert(res.data)
        document.cookie = 'token=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;'
        this.$router.push("/")
      }).catch(e => {
    ...
    async updatePersonalInfo() {
      await axios.put(`${url}/users/profile`, {
    ...
    async updatePassword() {
      await axios.put(`${url}/users/password`, {
        email: this.email,
