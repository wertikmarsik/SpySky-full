...
<div class="main-container" id="pricing-page">
    ...
    <div class="hero-container">
        <div class="hero-overlay">
            ...
            <div class="hero-nav">
                <div id="header">Pricing</div>
                <p>
                    Stay engaged with us by subscribing to one of our plans. 
                    Receive the additional features and tools to make your experience on our web app better.
                </p>
            </div>
        </div>
        <planetModel />
    ...
    <div id="plans-block">
        <div class="block-header">
            ...
            <div class="header-container">
                <p class="header-mid">SUBSCRIPTION PLANS</p>
            </div>
            <p>
                We offer users free access to its online system with limited functionality. 
                Alternatively, users have the option to subscribe to one of the paid plans to unlock enhanced features and capabilities.
            </p>
          </div>
...
#plans-block .plans-container {
  ...
  #plans-block .info-container .info-list {
    display: flex;
    flex-direction: column;
    gap: 20px;
    font-size: 1rem;
  ...
  #plans-block .info-container .info-list div {
    display: flex;
    flex-direction: row;
    gap: 10px;
  }

  #plans-block .info-container a {
    color: #FFC8C2;
    font-weight: 600;
  }

  #plans-block .info-container button {
    margin-top: 30px;
  }
