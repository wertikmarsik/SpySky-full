<template>
<div class="main-container" id="about-us-page">
  ...
  <div class="hero-container">
    <div class="hero-overlay">
      ...
      <div class="hero-nav">
          ...
          <p>We are dedicated to addressing the issue of space debris. 
            Through advanced technology and collaboration, we raise awareness and promote responsible space practices.</p>
      </div>
    </div>
    <planetModel />
  </div>
      ...
      <div class="mission-text">
        <div class="block-header">
          ...
          <div class="header-container">
              <p class="header-mid">we inform people about the dangers of space</p>
          </div>
          <p>
            The danger of space debris is an important problem, but not many people know about it. 
            We want to teach more people about it by spreading information. 
            Our project aims to provide people with an online system that can find space junk and sort it based on how dangerous it is.
          </p>
          <p>
            We do not aim to resolve the complex issue of space debris, which is beyond our capability. 
            Rather, we want to enhance awareness through the provision of visualizations. 
            These visuals help people understand how serious the problem of space debris is, making it easier for everyone to become aware.
          </p>
        </div>
      </div>
      <div class="mission-text">
        <div class="block-header">
          ...
          <div class="header-container">
              <p class="header-mid">use of machine learning</p>
          </div>
          <p>
            We do not just take raw data from NASA and use it directly. 
            Instead, a machine learning engineer processes and analyzes the data to make it more useful for our project.
          </p>
        </div>
      </div>
      <div class="mission-img"></div>
...
#missions-grid .block-header {
  width: 100%;
}

#missions-grid .block-header p, 
#missions-grid .block-header div {
  text-align: left;
  width: 100%;
}
...
#missions-grid > div:nth-child(1){
  ...
  background-image: url("../../assets/background-textures/about-us-bg1.png");
